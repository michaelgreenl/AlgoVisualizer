                    ...
                    >
                        <div class="item">
                            ...
                            >
                                <span v-if="!index">
                                    <mark
                                        v-if="content.toLowerCase().startsWith(userInput.toLowerCase())"
                                        class="highlight"
                                    >
                                ...
                                <mark
                                    v-if="index || !content.toLowerCase().startsWith(userInput.toLowerCase())"
                                    class="highlight"
                                >
                                ...
                                <span v-else>
                                    {{
                                        content.substring(
                                            contentIndex + userInput.length,
                                            searchResults[content].indices[index + 1],
                                        )
                                    }}
                                </span>
                            </span>
                        ...
                        <span class="category">{{
                            `${searchResults[content].category.charAt(0).toUpperCase()}${searchResults[
                                content
