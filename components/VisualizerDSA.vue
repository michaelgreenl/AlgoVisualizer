        ...
        <header class="header">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="tab-buttons">
                    ...
                    <button
                        class="tab-button"
                        :class="{ selected: sidebarTabs.settings }"
                        @click="tabButtonClick('settings')"
                    >
        ...
        <div class="main">
            <div class="visual" :class="{ center: !sidebarOpen }">
                ...
                <div class="controls">
                    ...
                    <button
                        class="control-button"
                        :aria-label="visualPlaying ? 'Pause Animation' : 'Play Animation'"
                        @click="!timeline.restarting ? playClick() : null"
                    >
                    ...
                    <button
                        ...
                        :disabled="
                            (timeline.currStep > 0 &&
                                timeline.currStep ===
                                    Object.keys(timeline.tl.labels).filter((key) => !isNaN(key)).length) ||
            ...
            onComplete: () => {
                ...
                if (text[i].underlined.length) {
                    ...
                    for (const [j, underlined] of text[i].underlined.entries()) {
                        ...
                        const position =
                            j !== 0 ? tl.getById(`underline${i}${j - 1}`)._end : tl.getById(`text${i}`)._end;
